  ...
  <div class="wrapper">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow">
                    <a href="my-job-post.php"><span class="info-box-icon bg-red"><i class="ion ion-ios-people-outline"></i></span></a>
                ...
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow">
                    <a href="job-applications.php"><span class="info-box-icon bg-green"><i class="ion ion-ios-browsers"></i></span></a>
                    <div class="info-box-content">
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2023 <a href="scsit@Davv">Placement Portal</a>.</strong> All rights
        reserved.
      </div>
    </footer>
