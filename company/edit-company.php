...
// $query = "SELECT * FROM company WHERE id_user='$_SESSION[id_user]'";
// $toname = $conn->query($query);
// if($toname){
//   $row = mysqli_fetch_assoc($toname);
//   $_SESSION['name'] = $row['name'];
// }
// else{
//   echo "Query failed: " . mysqli_error($connnection);
// }
